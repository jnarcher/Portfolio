const projects: Project[] = [
    ...
    },
    {
        ...
        src: "https://github.com/jnarcher/monkeylang",
    },
    {
        title: "Sweeper",
        description: "Play minesweeper inside your terminal. Build with Go using the Bubbletea TUI framework.",
        imgs: ["https://github.com/jnarcher/sweeper/blob/main/github/screenshot.png?raw=true"],
        tags: ["Go", "Makefile"],
        src: "https://github.com/jnarcher/monkeylang",
    },
    {
    ...
    {
        title: "Monkeylang",
        description: "An interpreter written in Zig for a mock C-like language following the book \"Writing an Interpreter In Go\" by Thorsten Ball.",
        tags: ["Zig"],
        src: "https://github.com/jnarcher/monkeylang",
    },
];
